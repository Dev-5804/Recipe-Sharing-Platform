...
export default function DinnerCategory() {
      ...
      <main className="container mx-auto px-4 py-6 md:px-6 md:py-10">
          ...
          <div className="rounded-lg bg-muted p-6 text-center md:p-12">
            <div className="mx-auto max-w-[800px] space-y-4">
              ...
              <p className="text-muted-foreground md:text-xl">
                Explore hearty and delicious dinner recipes for every occasion!
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold tracking-tight">Popular Dinner Recipes</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {dinnerRecipes.length > 0 ? (
              ...
              <p className="text-muted-foreground">No dinner recipes found.</p>
            )}
          </div>
        </section>
      </main>
